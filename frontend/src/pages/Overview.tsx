  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-rock-light-500 mt-1">岩馆核心运营指标一览</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {overviewStats.map((stat, index) => {
          ...
          return (
            <Card key={index} className="p-6 hover:border-rock-dark-600 transition-all duration-300 hover:shadow-xl">
              ...
              <div className="mt-5">
                ...
                <p className="text-base text-rock-light-500 mt-2">{stat.label}</p>
              </div>
            </Card>
          );
        })}
