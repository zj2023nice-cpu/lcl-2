  ...
  return (
    <div className="min-h-screen bg-theme-bg p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-theme-text mb-2">全局消息提示系统测试</h1>
        <p className="text-theme-text-secondary mb-8">
          测试消息提示的各种功能：成功、失败、警告、加载中，以及消息合并逻辑。
        </p>

        <Card className="mb-6">
          <h2 className="text-xl font-semibold text-theme-text mb-4">基础消息类型</h2>
        ...
        <Card className="mb-6">
          <h2 className="text-xl font-semibold text-theme-text mb-4">自定义配置</h2>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-theme-card border border-theme-border rounded-lg text-theme-text focus:outline-none focus:ring-2 focus:ring-climbing-orange-500"
            ...
            <div>
              ...
              <input
                ...
                step="500"
              />
              <p className="text-xs text-theme-text-muted mt-1">设置为 0 表示不自动关闭</p>
            </div>
          </div>
        </Card>

        <Card className="mb-6">
          <h2 className="text-xl font-semibold text-theme-text mb-4">消息合并测试</h2>
        ...
        <Card>
          <h2 className="text-xl font-semibold text-theme-text mb-4">功能说明</h2>
